...
<div className="min-h-screen pb-28 sm:pb-0">
  <div className="lg:h-[767px] bg-gray-900">
      ...
      <div className="flex flex-col lg:flex-row justify-center items-center  gap-8 lg:gap-0 lg:mt-0" style={{marginTop:'-50px'}}>
        <div className="flex-1 w-full mb-6 bg-white rounded-xl shadow-xl lg:scale-95" >
          <div className="text-center p-12">
            <p className="text-3xl lg:text-2xl xl:text-3xl pb-2">Basic</p>
            <div className="flex justify justify-center items-center">
              <span className="font-extrabold text-5xl lg:text-4xl xl:text-2xl align-text-middle px-0">$ 79</span>
              <span className="font-normal text-l text-gray-500 inline-block align-text-middle">/month</span>
            </div>
          </div>
          <div className="bg-gray-100 rounded-b-xl border-t-2 border-gray-200/20 p-5">
            <ul className="space-y-4">
              ...
              <li className="flex">
                ...
                <span className="text-gray-500">leap into electronic typesetting remaining. </span>
              </li>
              <li className="flex">
                <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 mr-3 text-green-500" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7" />
        ...
        <div className="lg:max-w-max mb-12 relative w-full bg-white rounded-xl shadow-xl border-2 border-indigo-600 l:scale-110 z-10">
          <div className="text-center p-8">
            <p className="text-3xl lg:text-2xl xl:text-3xl pb-4 font-semibold">Most Popular</p>
            <div className="flex justify justify-center items-center">
              <span className="font-extrabold text-2l lg:text-4xl xl:text-4xl align-text-middle px-3">$ 149</span>
          ...
          <div className="bg-gray-100 rounded-b-xl border-t-2 border-gray-200/20 p-5">
            ...
            <button type="button" className="w-full text-center bg-indigo-600 text-lg text-white mt-8 p-3 rounded shadow-xl transition hover:text-white hover:bg-indigo-700">Try Now</button>
          </div>
        ...
        <div className="flex-1 w-full mb-6 bg-white rounded-xl shadow-xl lg:scale-95">
          <div className="text-center p-12">
            <p className="text-3xl lg:text-2xl xl:text-3xl pb-4">Standard</p>
            <div className="flex justify justify-center items-center">
            <span className="font-extrabold text-5xl lg:text-4xl xl:text-2xl align-text-middle px-0">$ 79</span>
            <span className="font-normal text-l text-gray-500 inline-block align-text-middle">/month</span>
            </div>
