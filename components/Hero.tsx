...
// const Hero = () => {
//   return (
//     <div className="hero bg-cover bg-center text-center py-60 " style={{ backgroundImage: 'url(images/nature.jpg)' }}>
//       <h1 className="text-5xl font-bold mb-4">Welcome to Our Product</h1>
//       <p className="text-xl mb-8">This is the best product for your needs.</p>
...
export default function Example() {
  ...
  return (
    <div className="bg-white">
      <header className="absolute inset-x-0 top-0 z-50 " style={{marginTop:'-10px'}} >
          ...
          <div className="flex lg:flex-1">
            <a href="#" className="-m-1.5 p-1.5">
              ...
              <img
                ...
                src="images/logo.png"  style={{ width:'100px',height:'100px'}}
...
style={{ backgroundImage: 'url(images/image3.jpg)' }}>
        ...
        <div className="mx-auto max-w-2xl py-32 sm:py-48 lg:py-56">
          ...
          <div className="text-center">
            <h5 className="text-4xl font-bold tracking-tight text-gray-900 sm:text-5xl">
            Save trees and save the <br/>planet.
            </h5>
